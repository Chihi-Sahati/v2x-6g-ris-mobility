...
class MAPPOTrainer:
    ...
    def train(self) -> Dict[str, float]:
        ...
        # Get data from buffer (detach states/actions/log_probs for PPO updates)
        ...
        # Before clearing buffer, save the count for loss averaging
        buf_len = len(self.buffer)

        # Clear buffer
        self.buffer.clear()

        num_updates = self.ppo_epochs * (buf_len // self.mini_batch_size + 1)
        return {
