...
// Authors: AlHussein A. Al-Sahati and Houda Chihi
// Version: 2.0
...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun({ text: "I. INTRODUCTION", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "The integration of artificial intelligence (AI) and machine learning (ML) techniques into wireless network operations has demonstrated remarkable potential for addressing the complexity and dynamism inherent in 6G V2X environments. Multi-Agent Reinforcement Learning (MARL) provides a natural framework for distributed decision-making in scenarios involving multiple interacting entities, such as vehicles, base stations, and RIS panels. However, conventional MARL approaches often lack the structured reasoning and validation mechanisms necessary for safety-critical vehicular applications, where decision failures can have severe consequences for passenger safety and network reliability.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { line: 276 },
        children: [new TextRun({
          text: "We propose a novel decentralized AI Agent framework that integrates the Agent Loop Pattern from NetOps-Guardian-AI with MARL algorithms (QMIX and MAPPO) for RIS-assisted V2X mobility management, providing structured decision-making with built-in validation mechanisms.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { line: 276 },
        children: [new TextRun({
          text: "We formulate the joint RIS phase shift optimization and handover management problem as a Constrained Markov Decision Process (CMDP) that explicitly accounts for URLLC reliability and latency requirements specified in 3GPP standards.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { line: 276 },
        children: [new TextRun({
          text: "We develop three specialized agents—RIS Optimization Agent, Handover Management Agent, and Resource Allocation Agent—that collaboratively optimize network performance while satisfying diverse QoS constraints.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { line: 276 },
        children: [new TextRun({
          text: "We provide comprehensive theoretical analysis including Lyapunov stability theory for convergence guarantees and sample complexity bounds for the proposed MARL algorithms.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { line: 276 },
        children: [new TextRun({
          text: "We conduct extensive simulations under realistic 6G mmWave channel conditions (28 GHz, 400 MHz bandwidth) demonstrating 98.5% handover success rate at speeds up to 500 km/h with URLLC-compliant latency below 1 ms.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun({ text: "II. RELATED WORK", bold: true })]
      }),

      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "A. RIS-Assisted Wireless Communications", bold: true })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "B. Multi-Agent Reinforcement Learning in Wireless Networks", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "Yu et al. [4] demonstrated the surprising effectiveness of Proximal Policy Optimization (PPO) in cooperative multi-agent games, introducing MAPPO as a simple yet powerful approach for multi-agent coordination. Their work challenged the prevailing assumption that complex value function factorization methods are necessary for effective multi-agent learning, showing that properly tuned PPO can achieve state-of-the-art performance with significantly simpler implementation.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "C. AI Agent Architectures", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "The Agent Loop Pattern, as implemented in the NetOps-Guardian-AI framework [5], provides a structured approach for autonomous network operations. The pattern defines an iterative decision cycle comprising analysis, selection, execution, validation, and iteration phases, ensuring that AI-driven decisions undergo rigorous verification before implementation. This architecture has demonstrated effectiveness in network operations contexts, providing a foundation for its application to V2X mobility management scenarios.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun({ text: "III. SYSTEM MODEL", bold: true })]
      }),

      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "A. Network Topology", bold: true })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "B. Channel Model", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "We adopt the 3GPP TR 38.901 channel model [6] for Urban Macro (UMa) scenarios, which accurately captures the propagation characteristics of mmWave frequencies in vehicular environments. The received signal at vehicle v from gNB b can be expressed as:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        children: [new TextRun({
          text: "y_v(t) = h_v,b(t) · s_b(t) + Σ_{r∈R} h_v,r(t) · Θ_r(t) · g_r,b(t) · s_b(t) + n_v(t)    (1)",
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "The path loss for LOS and NLOS conditions follows the 3GPP specifications. For LOS conditions, the path loss in dB is given by:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { before: 150, after: 150 },
        children: [new TextRun({
          text: "PL_LOS = 28 + 22·log₁₀(d_3D) + 20·log₁₀(f_c)    (2)",
          size: 20, italics: true
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "where d_3D is the 3D distance between transmitter and receiver in meters, and f_c is the carrier frequency in GHz. For NLOS conditions, the path loss is:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { before: 150, after: 150 },
        children: [new TextRun({
          text: "PL_NLOS = 13.54 + 39.08·log₁₀(d_3D) + 20·log₁₀(f_c) - 0.6·(h_UE - 1.5)    (3)",
          size: 20, italics: true
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "where h_UE is the user equipment height in meters. The LOS probability is modeled as:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { before: 150, after: 150 },
        children: [new TextRun({
          text: "P(LOS) = min(18/d_2D, 1) · (1 - exp(-d_2D/63)) + exp(-d_2D/63)    (4)",
          size: 20, italics: true
        })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "C. RIS Signal Model", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "Each RIS panel comprises N passive reflecting elements capable of independently adjusting their phase shifts. The RIS-assisted channel gain can be expressed as:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { before: 150, after: 150 },
        children: [new TextRun({
          text: "h_RIS = Σ_{n=1}^{N} h_{v,r,n} · g_{r,b,n} · exp(j·θ_{r,n})    (5)",
          size: 20, italics: true
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "where h_{v,r,n} and g_{r,b,n} represent the channel coefficients for the n-th element, and θ_{r,n} is the controllable phase shift. The optimal phase shift that maximizes the combined signal strength is given by:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { before: 150, after: 150 },
        children: [new TextRun({
          text: "θ*_{r,n} = arg(h_{v,r,n}) + arg(g_{r,b,n})    (6)",
          size: 20, italics: true
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "In practice, phase shifts are quantized due to hardware constraints. With k-bit quantization, the phase shift can take values from the discrete set:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { before: 150, after: 150 },
        children: [new TextRun({
          text: "θ_{r,n} ∈ {0, 2π/2^k, 4π/2^k, ..., 2π(2^k-1)/2^k}    (7)",
          size: 20, italics: true
        })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "D. SINR and Capacity", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "The Signal-to-Interference-plus-Noise Ratio (SINR) at vehicle v when served by gNB b is given by:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { before: 150, after: 150 },
        children: [new TextRun({
          text: "γ_v(t) = P_b·|h_v,b(t) + h_RIS(t)|² / (Σ_{b'≠b} P_{b'}·I_{v,b'}(t) + N_0·W)    (8)",
          size: 20, italics: true
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "where P_b is the transmit power of gNB b, I_{v,b'}(t) represents interference from neighboring gNBs, and N_0·W is the noise power. The achievable data rate for vehicle v is given by the Shannon capacity formula:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "E. Mobility Model", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "Vehicle mobility is modeled using the Gauss-Markov mobility model, which captures the temporal correlation of vehicle velocities. The velocity update equation is:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { before: 150, after: 150 },
        children: [new TextRun({
          text: "v(t+Δt) = α·v(t) + (1-α)·μ + σ·√(1-α²)·ξ    (10)",
          size: 20, italics: true
        })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "F. Problem Formulation as CMDP", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "We formulate the joint RIS optimization and handover management problem as a Constrained Markov Decision Process (CMDP) defined by the tuple M = ⟨S, A, P, R, γ, C⟩, where S is the state space, A is the action space, P is the transition probability, R is the reward function, γ is the discount factor, and C represents the constraints.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "The objective is to maximize the long-term weighted sum of vehicle data rates while satisfying URLLC constraints:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { before: 150, after: 150 },
        children: [new TextRun({
          text: "max_π E[Σ_{t=0}^{∞} γ^t · Σ_{v∈V(t)} w_v · R_v(t) | π]    (11)",
          size: 20, italics: true
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "subject to the URLLC latency constraint:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { before: 150, after: 150 },
        children: [new TextRun({
          text: "P(T_{E2E,v}(t) > τ_max) ≤ ε, ∀v ∈ V(t)    (12)",
          size: 20, italics: true
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "where τ_max = 1 ms and ε = 10⁻⁵ (99.999% reliability), and the handover success rate constraint:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { before: 150, after: 150 },
        children: [new TextRun({
          text: "HSR(t) ≥ HSR_min, HSR_min = 95%    (13)",
          size: 20, italics: true
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "The state space S comprises vehicle states, gNB states, RIS states, and channel states. The action space A includes RIS phase shift configurations, handover decisions, and resource allocations. The constraints C enforce QoS requirements essential for safety-critical V2X applications.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun({ text: "IV. AI AGENT FRAMEWORK ARCHITECTURE", bold: true })]
      }),

      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "A. Agent Loop Pattern", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "The proposed AI Agent framework integrates the Agent Loop Pattern from NetOps-Guardian-AI, providing a structured approach for autonomous decision-making in V2X mobility management. The Agent Loop Pattern defines an iterative cycle comprising five distinct phases: Analyze, Select, Execute, Validate, and Iterate. Each phase serves a specific purpose in ensuring robust and reliable decision-making.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "In the Analyze phase, the agent processes the current observation to extract relevant features and detect patterns. This includes analyzing channel state information, vehicle mobility patterns, network load conditions, and historical performance metrics. The Select phase employs the learned policy π(a|s) to choose an action based on the analysis results, incorporating exploration-exploitation trade-offs for learning.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "The Execute phase applies the selected action to the environment, triggering RIS phase updates, handover procedures, or resource reallocations. The Validate phase verifies the effectiveness of the executed action by comparing predicted outcomes with actual results, checking constraint satisfaction, and detecting potential failures. If validation fails, the Iterate phase refines the action with modified parameters, repeating the cycle until successful validation or maximum retry attempts are reached.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "B. Specialized Agents", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "Our framework comprises three specialized agents, each responsible for a specific aspect of mobility management. The RIS Optimization Agent focuses on dynamic phase shift configuration to maximize signal quality and coverage. It analyzes channel state information, identifies coverage holes and signal degradation areas, and computes optimal phase configurations using a learned policy network.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "The Handover Management Agent makes proactive handover decisions based on trajectory prediction and signal quality forecasts. It implements a hysteresis-based handover algorithm enhanced with machine learning for improved prediction accuracy. The Resource Allocation Agent optimizes spectrum and power allocation to maximize network throughput while satisfying QoS constraints.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "C. Inter-Agent Coordination", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { before: 150, after: 150 },
        children: [new TextRun({
          text: "a* = argmax_a Σ_i Q_i(s, a_i) subject to C(s, a) ≤ c_threshold    (14)",
          size: 20, italics: true
        })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun({ text: "V. MULTI-AGENT REINFORCEMENT LEARNING ALGORITHMS", bold: true })]
      }),

      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "A. QMIX Value Decomposition", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "QMIX provides a value-decomposition approach that enables centralized training with decentralized execution. The method factorizes the joint action-value function Q_tot into a monotonic combination of individual agent Q-functions:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { before: 150, after: 150 },
        children: [new TextRun({
          text: "Q_tot(s, a) = f_mix(Q_1(s_1, a_1), ..., Q_n(s_n, a_n))    (15)",
          size: 20, italics: true
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "subject to the monotonicity constraint:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "The mixing network f_mix is implemented using hypernetworks that generate weights conditioned on the global state, ensuring the monotonicity constraint through non-negative weight generation via absolute value activation.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "B. MAPPO Policy Optimization", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "MAPPO extends PPO to multi-agent settings with centralized value functions. The policy objective is:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { before: 150, after: 150 },
        children: [new TextRun({
          text: "L^CLIP(θ) = E[min(r(θ)·Â, clip(r(θ), 1-ε, 1+ε)·Â)]    (17)",
          size: 20, italics: true
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "where r(θ) = π_θ(a|s)/π_θ_old(a|s) is the probability ratio, Â is the advantage estimate computed using Generalized Advantage Estimation (GAE), and ε is the clip parameter. The value function loss is:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "The total objective combines policy loss, value loss, and entropy bonus:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { before: 150, after: 150 },
        children: [new TextRun({
          text: "L(θ, φ) = -L^CLIP + c_1·L^VF - c_2·H(π_θ)    (19)",
          size: 20, italics: true
        })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "C. Convergence Analysis", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "We provide convergence guarantees for the proposed MARL algorithms using Lyapunov stability theory. Define the Lyapunov function:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        spacing: { before: 150, after: 150 },
        children: [new TextRun({
          text: "V(s) = E[Σ_{t=0}^{∞} γ^t · ||∇_θ J(θ_t)||²]    (20)",
          size: 20, italics: true
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "Under standard assumptions of smooth policy gradients and bounded gradients, we establish that V(s) decreases monotonically during training, ensuring convergence to a stationary point. The convergence rate for QMIX satisfies:",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "where Q* is the optimal Q-function and ρ depends on the learning rate and mixing network architecture.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun({ text: "VI. SIMULATION RESULTS AND DISCUSSION", bold: true })]
      }),

      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "A. Simulation Setup", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "We evaluate the proposed framework through extensive simulations using a custom-built V2X simulator implementing the 3GPP TR 38.901 channel model and Gauss-Markov mobility model. The simulation parameters are summarized in Table I, aligned with 6G specifications and manuscript parameters.",
          size: 20
        })]
      }),
          ...
          new TableRow({
            ...
            children: [
              new TableCell({
                ...
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "Parameter", bold: true, size: 18 })] })]
              }),
              new TableCell({
                borders: cellBorders,
                shading: { fill: colors.tableBg, type: ShadingType.CLEAR },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "Value", bold: true, size: 18 })] })]
              })
            ]
          }),
          new TableRow({
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "B. Performance Comparison", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "Table II presents a comprehensive performance comparison of the proposed Agent Loop + MARL framework against several baseline approaches. The results demonstrate significant improvements across all key metrics, validating the effectiveness of our proposed approach.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun({ text: "C. Results Analysis", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "The proposed Agent Loop + MARL framework achieves a handover success rate of 98.5%, significantly exceeding the 95% minimum requirement for URLLC applications. This represents a 3.3 percentage point improvement over the MARL-only baseline and an 11.2 percentage point improvement over conventional handover methods. The improvement can be attributed to the Agent Loop Pattern's structured validation mechanism, which ensures that each handover decision is verified before execution.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "The RIS-assisted scheme provides an average SINR improvement of 8.2 dB compared to non-RIS baselines. This substantial gain is achieved through intelligent phase shift optimization that dynamically adapts to vehicle mobility patterns. The 4-bit phase quantization provides a practical trade-off between hardware complexity and performance, with each RIS element capable of 16 discrete phase states.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "End-to-end latency remains below 1 ms across all test scenarios, with the proposed framework achieving an average latency of 0.85 ms. This satisfies the stringent URLLC requirements for safety-critical V2X applications. The Agent Loop's validation phase plays a crucial role in maintaining low latency by preventing failed handover attempts that would otherwise require time-consuming recovery procedures.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun({ text: "VII. CONCLUSION", bold: true })]
      }),
      ...
      new Paragraph({
        ...
        indent: { firstLine: 480 },
        children: [new TextRun({
          text: "The theoretical analysis using Lyapunov stability theory provides convergence guarantees for the proposed MARL algorithms, establishing a rigorous foundation for practical deployment. Future work will extend the framework to incorporate federated learning for privacy-preserving distributed training and investigate platoon-based cooperative driving scenarios that leverage inter-vehicle coordination.",
          size: 20
        })]
      }),
      ...
      new Paragraph({
        spacing: { line: 276 },
        children: [new TextRun({ text: "[1] Q. Wu and R. Zhang, \"Intelligent reflecting surface enhanced wireless network via joint active and passive beamforming,\" IEEE Trans. Wireless Commun., vol. 18, no. 11, pp. 5394-5409, Nov. 2019.", size: 18 })]
      }),
      new Paragraph({
        spacing: { line: 276 },
        children: [new TextRun({ text: "[2] M. Di Renzo et al., \"Smart radio environments empowered by reconfigurable intelligent surfaces,\" IEEE J. Sel. Areas Commun., vol. 38, no. 11, pp. 2450-2525, Nov. 2020.", size: 18 })]
      }),
      new Paragraph({
        spacing: { line: 276 },
        children: [new TextRun({ text: "[3] T. Rashid et al., \"QMIX: Monotonic value function factorisation for deep multi-agent reinforcement learning,\" in Proc. ICML, 2018, pp. 4295-4304.", size: 18 })]
      }),
      new Paragraph({
        spacing: { line: 276 },
        children: [new TextRun({ text: "[4] C. Yu et al., \"The surprising effectiveness of PPO in cooperative multi-agent games,\" in Proc. NeurIPS, 2022.", size: 18 })]
      }),
      new Paragraph({
        spacing: { line: 276 },
        children: [new TextRun({ text: "[5] A. A. Al-Sahati and H. Chihi, \"NetOps-Guardian-AI: A unified autonomous network operations platform,\" GitHub Repository, 2026. [Online]. Available: https://github.com/Chihi-Sahati/NetOps-Guardian-AI-", size: 18 })]
      }),
      new Paragraph({
        spacing: { line: 276 },
        children: [new TextRun({ text: "[6] 3GPP, \"Study on channel model for frequencies from 0.5 to 100 GHz,\" 3GPP TR 38.901 V16.1.0, 2020.", size: 18 })]
      }),
      new Paragraph({
        spacing: { line: 276 },
        children: [new TextRun({ text: "[7] W. Saad, M. Bennis, and M. Chen, \"A vision of 6G wireless systems: Applications, enabling technologies, and research challenges,\" IEEE Netw., vol. 34, no. 3, pp. 134-142, May 2020.", size: 18 })]
      }),
      new Paragraph({
        spacing: { line: 276 },
        children: [new TextRun({ text: "[8] K. B. Letaief, W. Chen, Y. Shi, J. Zhang, and Y.-J. A. Zhang, \"The roadmap to 6G: AI empowered wireless networks,\" IEEE Commun. Mag., vol. 57, no. 8, pp. 84-90, Aug. 2019.", size: 18 })]
      }),
      new Paragraph({
        spacing: { line: 276 },
        children: [new TextRun({ text: "[9] E. Björnson, Ö. Özdogan, and E. G. Larsson, \"Reconfigurable intelligent surfaces: Three myths and two critical questions,\" IEEE Commun. Mag., vol. 58, no. 12, pp. 90-96, Dec. 2020.", size: 18 })]
      }),
      new Paragraph({
        spacing: { line: 276 },
        children: [new TextRun({ text: "[10] Y. Liu et al., \"Reconfigurable intelligent surfaces: Principles and opportunities,\" IEEE Commun. Surv. Tuts., vol. 23, no. 3, pp. 1546-1577, 3rd Quart. 2021.", size: 18 })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun({ text: "BIOGRAPHIES", bold: true })]
      }),
